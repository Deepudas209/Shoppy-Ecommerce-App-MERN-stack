                  ...
                  <div className="w-full min-w-[280px] md:min-w-[320px] max-w-[280px] md:max-w-[320px] bg-white rounded-sm shadow ">
                    ...
                    <div className="p-4 grid gap-3">
                        ...
                        <div className="flex gap-3">
                            ...
                            <p className="text-red-500 line-through p-1 animate-pulse rounded-full bg-slate-200 w-full py-2"></p>
                        </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="p-4 grid gap-3">
                        ...
                        <button className="text-sm bg-blue-600 hover:bg-blue-800 text-white px-3 py-0.5 rounded-full"
