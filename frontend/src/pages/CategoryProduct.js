...
const CategoryProduct = () => {
    ...
    const fetchData = async () => {
      const response = await fetch(SummaryApiOne.filterProduct.url,{
        method: SummaryApiOne.filterProduct.method,
        headers: {
    ...
    useEffect(() => {
      const arrayOfCategory = Object.keys(selectCategory).map(categoryKeyName => {
        // console.log("categoryKeyName", categoryKeyName);
      ...
      // /product-category?category=camera
      // console.log("selectedCategory", arrayOfCategory);
    },[selectCategory])
