...
import SummaryApiOne from './../common/index';
...
const ProductDetails = () => {
  ...
  const fetchProductDetails = async () => {
    setLoading(true)
    const response = await fetch(SummaryApiOne.productDetails.url,{
      method: SummaryApiOne.productDetails.method,
      headers: {
    ...
    <div className='container mx-auto p-4'>
      <div className='min-h-[200px] flex flex-col lg:flex-row gap-4'>
        ...
        {/* product details */}
        {
          ...
          <h2 className='text-2xl lg:text-4xl font-medium h-6 lg:h-8 w-full rounded-full bg-slate-200 animate-pulse'></h2>
          <p className='capitalize text-slate-400 bg-slate-200 min-w-[100px] animate-pulse h-6 lg:h-8 w-full rounded-full'></p>
          <div className='text-yellow-600 bg-slate-200 h-6 lg:h-8 w-full animate-pulse flex items-center gap-1 rounded-full'>
            
          </div>
          <div className='flex items-center gap-4 text-2xl lg:text-3xl font-medium my-1 h-6 lg:h-8 w-full animate-pulse'>
          ...
          <p className='bg-blue-200 text-red-600 px-2 font-semibold rounded-full inline-block w-fit'>{data?.brandName}</p>
          ...
          <div className='flex items-center gap-3 my-2'>
            <button
            className='border-2 border-orange-600 rounded-full px-3 py-1 min-w-[120px] hover:bg-orange-600 hover:text-white font-medium'
